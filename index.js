...
app.get('/aineg', apiLimiter, async (req, res) => {
    const completion = await openai.createChatCompletion({
        ...
        messages:[
            ...
            {role:'user', content: `Can you give me 1 negative question that is inversely correlated  with happiness (higher than -0.5) from published psychology peer reviewed articles. Include inline citation in parenthesis after the question. Also make sure the question can be answered based on current day from 0-10, and can be repeated everyday. (IMPORTANT: GIVE ME ONLY THE QUESTION AND INLINE CITATION IN ONE SENTENCE. These are scientific journals, please don't compromise their findings by making things up.)`},
        ],
        temperature: 0.7,
        max_tokens: 256,
        top_p: 1,
